...
ifneq ($(ALTERNATE_TARGET),)
    $(eval $(call set_provides,binutils_3,single,cross_no))
endif
...
binutils_3: $(RCPTS)/binutils_3.rcpt
...
$(RCPTS)/binutils_3.rcpt: $(binutils_3-archdeps)
	@touch $@
...
$(RCPTS)/binutils_3.a.rcpt: $(RCPTS)/gcc_4.rcpt
	@touch $@
