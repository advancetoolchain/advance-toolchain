...
%package devel
Summary: Advance Toolchain
Requires: advance-toolchain-%{at_major}-runtime = %{at_major_version}-%{at_revision_number}, __DEVEL_REQ__, environment-modules
Group: Development/Libraries
AutoReqProv: no
...
if [[ ! ( -d /usr/share/modules/modulefiles || -d /usr/share/Modules/modulefiles ) ]]; then
	# SLE Modules package doesn't create this directory
...
%defattr(-,root,root)
# Environment Module.
%{_datadir}/modules/modulefiles/%{at_ver_rev_internal}
