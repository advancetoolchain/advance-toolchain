...
#
#
$(eval $(call set_provides,openssl_1,multi,cross_no))
...
$(RCPTS)/openssl_1-32.a.rcpt: $(patsubst %,$(RCPTS)/%.rcpt,gcc_4 rsync_openssl)
	@touch $@

$(RCPTS)/openssl_1-64.a.rcpt: $(patsubst %,$(RCPTS)/%.rcpt,gcc_4 rsync_openssl)
	@touch $@
