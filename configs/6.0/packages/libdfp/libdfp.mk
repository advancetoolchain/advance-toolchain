...
#
#
$(eval $(call set_provides,libdfp_1,multi,cross_no))
...
$(RCPTS)/libdfp_1-32.a.rcpt: $(patsubst %,$(RCPTS)/%.rcpt,gcc_3 glibc_2-32.b \
                                                          rsync_libdfp)
	@touch $@

$(RCPTS)/libdfp_1-64.a.rcpt: $(patsubst %,$(RCPTS)/%.rcpt,gcc_3 glibc_2-64.b \
                                                          rsync_libdfp)
	@touch $@
