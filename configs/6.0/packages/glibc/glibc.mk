...
#
# Set main dependencies based on kind of build requested for this target
# multi = 32/64, single = compiler default bitsize only (usually 64)
$(eval $(call set_provides,glibc_h,multi,cross_yes))
...
$(RCPTS)/glibc_h.rcpt: $(glibc_h-archdeps)
	@touch $@
...
$(RCPTS)/glibc_h-32.a.rcpt: $(RCPTS)/gcc_1.rcpt $(RCPTS)/rsync_glibc.rcpt
	@touch $@

# Depends on 32-bit version only when providing it.
$(RCPTS)/glibc_h-64.a.rcpt:  $(RCPTS)/gcc_1.rcpt $(RCPTS)/rsync_glibc.rcpt \
                             $(filter %glibc_h-32.b.rcpt,$(glibc_h-archdeps))
	@touch $@

$(RCPTS)/glibc_1-32.a.rcpt: $(RCPTS)/gcc_2.rcpt
	@touch $@

$(RCPTS)/glibc_1-64.a.rcpt: $(RCPTS)/gcc_2.rcpt
	@touch $@
