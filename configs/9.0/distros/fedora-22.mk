...
ifeq ($(BUILD_ARCH),ppc64le)
    AT_NATIVE_PKGS_REQ += \(ibm-java-ppc64le-sdk-7.1\|java-1.7.1-ibm-devel\)
    AT_NATIVE_PKGS_REQ += glibc-devel bzip2-devel popt-devel
else
    AT_NATIVE_PKGS_REQ += \(ibm-java-ppc64-sdk-7.0\|java-1.7.1-ibm-devel\) \
