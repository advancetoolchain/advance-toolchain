...
%define __debug_install_post \
        ...
        bash %{_rpmdir}/split-debuginfo.sh --rpmdir %{_rpmdir} --dynamic %{at_work} --subpackage runtime "%{_builddir}/%{?buildsubdir}"\
        bash %{_rpmdir}/split-debuginfo.sh --rpmdir %{_rpmdir} --dynamic %{at_work} --subpackage mcore-libs "%{_builddir}/%{?buildsubdir}"\
        bash %{_rpmdir}/split-debuginfo.sh --rpmdir %{_rpmdir} --dynamic %{at_work} --subpackage devel "%{_builddir}/%{?buildsubdir}"\
        bash %{_rpmdir}/split-debuginfo.sh --rpmdir %{_rpmdir} --dynamic %{at_work} --subpackage libnxz "%{_builddir}/%{?buildsubdir}"\
        bash %{_rpmdir}/split-debuginfo.sh --rpmdir %{_rpmdir} --dynamic %{at_work} --subpackage profile "%{_builddir}/%{?buildsubdir}"\
%{nil}
