...
#
# Distro dependent basic definitions for RedHat Enterprise Server 10
# ==================================================================
...
# Override generic values from build.mk (RHEL 10 requires a power10)
BUILD_LOAD_ARCH := power10
BUILD_BASE_ARCH := power10
...
ifndef AT_DISTRO_REQ_PKGS
    AT_CROSS_PKGS_REQ :=
    AT_NATIVE_PKGS_REQ := libxslt docbook-style-xsl sqlite-devel libxcrypt-devel
    AT_COMMON_PKGS_REQ := zlib-.*devel ncurses-devel flex bison texinfo \
                          ncurses-libs createrepo glibc-devel gawk \
                          ...
                          perl-FindBin perl-IPC-Cmd perl-Pod-Html
    AT_CROSS_PGMS_REQ :=
    AT_NATIVE_PGMS_REQ :=
    AT_COMMON_PGMS_REQ :=
endif
