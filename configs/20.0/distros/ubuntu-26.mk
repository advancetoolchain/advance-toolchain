...
#
# Distro dependent basic definitions for Ubuntu 26.04 LTS
# =======================================================
...
ifndef AT_DISTRO_REQ_PKGS
    ...
    AT_COMMON_PKGS_REQ := zlib1g-dev libncurses-dev ncurses-term flex bison \
                          texinfo gawk fakeroot debhelper \
                          autoconf rsync curl bc libxml2-utils automake \
                          xutils-dev libtool wget \
