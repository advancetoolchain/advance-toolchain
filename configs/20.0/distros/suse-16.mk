...
#
# Distro dependent basic definitions for SuSE Enterprise Server 16
# ================================================================
...
# Override generic values from build.mk (SLES 16 requires a power10)
...
ifndef AT_DISTRO_REQ_PKGS
    ...
    AT_NATIVE_PKGS_REQ := libxslt popt-devel docbook-xsl-stylesheets \
                          ...
                          libncurses[0-9] liblzma[0-9] libfl[0-9]
